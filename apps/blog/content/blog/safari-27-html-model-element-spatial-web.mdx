...
BANGEOでは、このvisionOS側の動きについても[別記事で整理しています](/tech-articles/safari-27-beta-visionos-immersive-website-environments-webxr)。`<model>` は単体の3Dビューアとしてだけでなく、Apple Vision Pro向けのSpatial Web導線としても見ておきたい要素です。
