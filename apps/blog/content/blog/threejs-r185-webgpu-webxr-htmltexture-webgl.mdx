...
[BANGEO](https://www.bangeo.net)では、WebXRの仕様だけでなく、three.js、PlayCanvas、WebGPUなど、ブラウザで3D体験を作るための実装基盤も継続して追っています。今後はthree.js r185のWebGPU + WebXR対応について、実機での動作やWebGL版との差も確認していきたいと思います。
