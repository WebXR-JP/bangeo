...
WebXR開発者にとっては、ここが「今すぐ使うAPI」ではなく「今後の空間ブラウザ設計を読むための地図」になります。three.js / Babylon.js / PlayCanvasの学習を置き換えるものではないけれど、glTF、WASM、OpenXR、spatial UI、権限モデル、マルチサービス合成を考えるときの比較対象として重要です。
