---
title: "Sneezeとは？WebXRとは別の「空間ブラウザエンジン」をわかりやすく整理"
description: "Metaverse Standards ForumとRP1が発表したSneezeを、WebXRとの違い、SOM、近接ベースの発見、OpenXR/WASM構成から整理します。"
date: "2026年6月15日"
category: "TECH"
tags:
  - "Sneeze"
...
発表では、SneezeはApache 2.0ライセンスで公開され、RP1がリードアーキテクト兼メンテナとして関わると説明されています。この記事では、これを「WebXR Device APIの新機能」ではなく、Spatial Web / Open Metaverse Browser / 空間ブラウザの隣接トピックとして整理します。
