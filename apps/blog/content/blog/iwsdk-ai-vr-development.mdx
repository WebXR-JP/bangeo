---
title: "Immersive Web SDK（IWSDK）で始めるAI駆動のVR開発"
description: "MetaのオープンソースフレームワークIWSDKを使えば、コマンド1つでVR開発環境が立ち上がり、Claude CodeやCodexといったAIツールがコードの生成からテスト・修正までを自律的に行ってくれます。実際にBANGEOの記事ギャラリーをVR空間に作り、VR内で記事を読めるところまでを紹介します。"
date: "2026年4月13日"
category: "TECH"
tags:
  - "WebXR"
  ...
  - "Claude Code"
author: "BANGEO Team"
thumbnail: "/assets/tech/iwsdk-vr-scene.png"
draft: true
---

## はじめに

Metaが公開した **Immersive Web SDK（IWSDK）** は、WebXRのVR体験を手早く構築するためのオープンソースフレームワークです。
...
IWSDKでは、ゲームオブジェクトの振る舞いを**コンポーネント**（データ）と**システム**（ロジック）に分離して管理します。VRは72〜90FPSが求められるため、1フレームあたり11〜14msしか使えません。ECSパターンはこのパフォーマンス要件を満たすために設計されています。
...
Claude CodeやCodexは、このMCPサーバーを通じて40以上のツールにアクセスできます。
...
- [IWSDK GitHub リポジトリ](https://github.com/meta-quest/immersive-web-sdk)
- [Meta 公式ブログ記事](https://developers.meta.com/horizon/blog/accelerate-vr-development-with-ai-and-immersive-web-sdk/)
- [AI-Assisted Development: Technical Deep Dive](https://developers.meta.com/horizon/documentation/web/iwsdk-ai-assisted-development/)
- [PC + VRヘッドセットでWebXRを体験するガイド](/blog/pcvr-webxr-guide)
