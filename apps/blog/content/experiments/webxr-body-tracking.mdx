---
title: "WebXR Body Tracking — 全身トラッキング関節を点と線で可視化"
description: "WebXR Body Tracking proposal の body-tracking feature を使い、XRFrame.body の関節姿勢を確認する実験。PICOなど対応ブラウザでの実機検証に使います。"
date: "2026-07-03"
category: "WebXR Lab"
tags:
  - "WebXR"
